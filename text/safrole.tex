...
\begin{align}
  ...
  \end{cases} \\
  \nonumber \where z &= \mathcal{O}([k_b \mid k \orderedin \pendingset']) \\
...
\begin{align}
    ...
    \safroleticket \in \seq{\safroleticket} &\implies \left\{\,\begin{aligned}
        ...
        &\H_\¬sealsig \in \bandersig{\H_\¬authorbskey}{\mathsf{X}_T \concat \entropy'_3 \doubleplus i_\st¬entry}{\seunsignedheader(\H)}\,,\\
        &\mathbf{T} = 1
    \end{aligned}\right.\\
    ...
    \safroleticket \in \seq{\bskey} &\implies \left\{\,\begin{aligned}
        ...
        &\mathbf{T} = 0
    \end{aligned}\right.\\
  \H_\¬vrfsig &\in \bandersig{\H_\¬authorbskey}{\mathsf{X}_E\frown \banderout{\H_\¬sealsig}}{[]} \\
...
\begin{align}
  \entropyaccumulator' &\equiv \blake(\entropyaccumulator \frown \banderout{\H_\¬vrfsig})
\end{align}
...
\begin{equation}\label{eq:fallbackkeysequence}
  F\colon \left\{\ \begin{aligned}
    ...
    \cyclic{\mathbf{k}[\de(\blake_4(r \frown \mathcal{E}_4(i)))]}_\vk¬bs
...
\begin{align}\label{eq:epochmarker}
  \H_\¬epochmark &\equiv \begin{cases}
    \tup{ \entropyaccumulator, \entropy_1, [ \tup{k_b, k_e} \mid k \orderedin \pendingset' ] } \qquad\qquad &\when e' > e \\
    \none & \otherwise
  \end{cases}
\end{align}
...
\begin{align}\label{eq:ticketsextrinsic}
  \xttickets &\in \seq{\tuple{
    ...
    \isa{p}{\bandersnatch{\epochroot'}{\mathsf{X}_T \frown \entropy'_2 \doubleplus r}{[]}}
  }} \\
