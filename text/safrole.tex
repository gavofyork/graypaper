...
\begin{align}
    ...
    \safroleticket \in \sequence{\safroleticket} &\implies \abracegroup[\,]{
        ...
        &\H_\¬sealsig \in \bssignature{\H_\¬authorbskey}{\mathsf{X}_T \concat \entropy'_3 \append i_\st¬entry}{\encodeunsignedheader{\H}}\,,\\
        &\isticketed = 1
    }\\
...
\begin{align}\label{eq:ticketsextrinsic}
  \xttickets &\in \sequence{\tuple{
    ...
    \isa{\xt¬proof}{\bsringproof{\epochroot'}{\mathsf{X}_T \concat \entropy'_2 \append \xt¬entry}{\sq{}}}
  }} \\
