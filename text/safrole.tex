...
\begin{align}
  ...
  \forall \vkX \in \valkey : \vkX_\vk¬bs \in \bskey &\equiv \vkX_{0\dots+32} \\
  \forall \vkX \in \valkey : \vkX_\vk¬ed \in \edkey &\equiv \vkX_{32\dots+32} \\
  \forall \vkX \in \valkey : \vkX_\vk¬bls \in \blskey &\equiv \vkX_{64\dots+144} \\
  \forall \vkX \in \valkey : \vkX_\vk¬metadata \in \metadatakey &\equiv \vkX_{208\dots+128}
\end{align}
...
\begin{align}
  ...
  \end{cases} \\
  \nonumber \where z &= \getringroot([k_\vk¬bs \mid k \orderedin \pendingset']) \\
...
\begin{equation}\label{eq:fallbackkeysequence}
  F\colon \abracegroup[\ ]{
    \tuple{\hash,\,\sequence{\valkey}} &\to \sequence{\bskey}_\epochlen\\
