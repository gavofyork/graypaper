...
\begin{align}
    \nonumber \using i = \gamma'_\mathbf{s}[\h¬timeslot]^\circlearrowleft\colon \\
...
\begin{align}
  \eta'_0 &\equiv \blake(\eta_0 \frown \banderout{\mathbf{H}_v})
\end{align}
