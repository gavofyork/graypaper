...
\begin{align}
  \forall \tup{\xc¬reporthash, \xc¬offender, \xc¬signature} &\in \xtculprits : \bigwedge \left\{
  \begin{aligned}
    &\xc¬reporthash \in \badset' \,,\\
    &\xc¬offender \in \mathbf{k} \,,\\
    &\xc¬signature \in \sig{\xc¬offender}{\mathsf{X}_G \concat \xc¬reporthash}
  \end{aligned}\right.\\
  \forall \tup{\xf¬reporthash, \xf¬validity, \xf¬offender, \xf¬signature} &\in \xtfaults : \bigwedge \left\{ \begin{aligned}
  ...
  \end{aligned}\right.\\
  \nonumber\where \mathbf{k} &= \{i_\vk¬ed \mid i \in \previousset \cup \activeset\} \setminus \offenders
\end{align}
...
\begin{align}
  ...
  &\{\xv¬reporthash \mid \tup{\xv¬reporthash, \xv¬epochindex, \xv¬judgments} \in \xtverdicts\} \disjoint \goodset \cup \badset \cup \wonkyset
\end{align}
