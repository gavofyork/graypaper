...
\begin{equation}
  \begin{aligned}
    ...
    \where \xtverdicts &\in \seq{\tup{\hash, \ffrac{\tau}{\mathsf{E}} - \N_2, \seq{\tup{\{\top, \bot\}, \N_{\mathsf{V}}, \mathbb{E}}}_{\floor{\nicefrac{2}{3}\mathsf{V}} + 1}}}\\
    \also \xtculprits &\in \seq{\hash, \hash_E, \mathbb{E}} \,,\quad
    \xtfaults \in \seq{\hash, \{\top,\bot\}, \hash_E, \mathbb{E}}
  \end{aligned}
\end{equation}
