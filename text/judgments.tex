...
\begin{equation}
  \begin{aligned}
    ...
    \where \xtverdicts &\in \seq{\tup{\hash, \ffrac{\thetime}{\mathsf{E}} - \N_2, \seq{\tup{\{\top, \bot\}, \N_{\valcount}, \mathbb{E}}}_{\floor{\nicefrac{2}{3}\valcount} + 1}}}\\
    \also \xtculprits &\in \seq{\hash, \edkey, \mathbb{E}} \,,\quad
    \xtfaults \in \seq{\hash, \{\top,\bot\}, \edkey, \mathbb{E}}
  \end{aligned}
\end{equation}
...
\begin{align}
  &\begin{aligned}
    ...
    &\quad\where \mathbf{k} = \begin{cases}
      \activeset &\when a = \displaystyle \ffrac{\thetime}{\mathsf{E}}\\
...
\begin{equation}\label{eq:removenonpositive}
  \forall c \in \coreindex : \rho^\dagger[c] = \begin{cases}
    \none &\!\!\!\!\when \{ (\blake(\rho[c]_w), t) \in \verdicts, t < \floor{\nicefrac{2}{3}\valcount} \} \\
    \rho[c] &\!\!\!\!\otherwise
  \end{cases}\!\!\!\!\!\!\!
\end{equation}
...
\begin{align}
  \H_\¬offendersmark &\equiv \sq{ k \mid (r, k, s) \in \xtculprits} \frown \sq{ k \mid (r, v, k, s) \in \xtfaults }
\end{align}
