...
\begin{aligned}
  ...
  \immed_X \equiv \sext{l_X}{\fixeddecode{l_X}{\instructions\subrange{\imath+1}{l_X}}}
\end{aligned}
\end{equation}
...
\begin{aligned}
    ...
    \immed_X &\equiv \sext{l_X}{\fixeddecode{l_X}{\instructions\subrange{\imath+2}{l_X}}} \\
    \using l_Y &= \min(4, \max(0, \ell - l_X - 1)) \,,\quad&
    \immed_Y &\equiv \sext{l_Y}{\fixeddecode{l_Y}{\instructions\subrange{\imath+2+l_X}{l_Y}}}
\end{aligned}
\end{equation}
...
\begin{aligned}
    ...
    \immed_X &= \sext{l_X}{\fixeddecode{l_X}{\instructions\subrange{\imath+2}{l_X}}} \\
    \using l_Y &= \min(4, \max(0, \ell - l_X - 1)) \,,\quad&
    \immed_Y &= \sext{l_Y}{\fixeddecode{l_Y}{\instructions\subrange{\imath+2+l_X}{l_Y}}}
\end{aligned}
\end{equation}
...
\begin{equation}
  \begin{aligned}
    ...
    \immed_X &= \sext{l_X}{\fixeddecode{l_X}{\instructions\subrange{\imath+3}{l_X}}} \\
    \using l_Y &= \min(4, \max(0, \ell - l_X - 2)) \,,\quad&
    \immed_Y &= \sext{l_Y}{\fixeddecode{l_Y}{\instructions\subrange{\imath+3+l_X}{l_Y}}}
  \end{aligned}
\end{equation}
