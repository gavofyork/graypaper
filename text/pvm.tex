...
\begin{align}
  \Psi&\colon \left\{\begin{aligned}
    (\blob, \N_R, \gas, \regs, \ram) &\to (\{\halt, \panic, \oog\} \cup \{\fault, \host\} \times \N_R, \N_R, \Z_G, \regs, \ram)\\
  ...
  \deblob&\colon\left\{\begin{aligned}
    \blob &\to \tuple{\blob, \mathbb{B}, \seq{\N_R}} \cup \error \\
...
\begin{equation}
  \Psi_1\colon \left\{\begin{aligned}
    (\blob, \mathbb{B}, \seq{\N_R}, \N_R, \gas, \regs, \ram) &\to (\{\panic, \halt, \continue \} \cup \{\fault, \host\} \times \N_R, \N_R, \Z_G, \regs, \ram)\\
...
\begin{align}
  &\Psi_H\colon \left\{\begin{aligned}
    \tuple{\begin{aligned}
      &\blob, \N_R, \gas, \regs,\\&\ram, \Omega\langle X \rangle, X
    \end{aligned}
    }
    &\to
    ...
    \end{cases} \\
    \end{aligned}\right.\!\!\!\!\!\!\!\!\\
    &\Omega\langle X \rangle \equiv (\N, \gas, \regs, \ram, X) \to \tuple{\{\continue, \halt, \panic, \oog\}, \gas, \regs, \ram, X} \cup \{\fault\} \times \N_R
\end{align}
...
\begin{equation}
  \Psi_M\colon \left\{\begin{aligned}
    \left(
      \blob, \N_R, \gas, \blob_{:\mathsf{Z}_I}, \Omega\langle X \rangle, X
