...
\begin{equation}
  ...
  \immed_X \equiv \decode{8}{\instructions_{\imath+2\dots+8}}
\end{equation}
...
\begin{longtable}{p{8mm} p{25mm} p{5mm} p{100mm}}
  ...
  31&\token{store\_imm\_u16}&1&$\memwr_{\immed_X\dots+2} = \fixedencode{2}{\immed_Y \bmod 2^{16}}$\\ \mrule
  32&\token{store\_imm\_u32}&1&$\memwr_{\immed_X\dots+4} = \fixedencode{4}{\immed_Y \bmod 2^{32}}$\\ \mrule
  33&\token{store\_imm\_u64}&1&$\memwr_{\immed_X\dots+8} = \fixedencode{8}{\immed_Y}$\\
\bottomrule
\end{longtable}
...
\begin{longtable}{p{8mm} p{25mm} p{5mm} p{100mm}}
  ...
  54&\token{load\_u16}&1&$\reg'_A = \decode{2}{\memr_{\immed_X\dots+2}}$\\ \mrule
  55&\token{load\_i16}&1&$\reg'_A = \sext_2(\decode{2}{\memr_{\immed_X\dots+2}})$\\ \mrule
  56&\token{load\_u32}&1&$\reg'_A = \decode{4}{\memr_{\immed_X\dots+4}}$\\ \mrule
  57&\token{load\_i32}&1&$\reg'_A = \sext_4(\decode{4}{\memr_{\immed_X\dots+4}})$\\ \mrule
  58&\token{load\_u64}&1&$\reg'_A = \decode{8}{\memr_{\immed_X\dots+8}}$\\ \mrule
  59&\token{store\_u8}&1&$\memwr_{\immed_X} = \reg_A \bmod 2^8$\\ \mrule
  60&\token{store\_u16}&1&$\memwr_{\immed_X\dots+2} = \fixedencode{2}{\reg_A \bmod 2^{16}}$\\ \mrule
  61&\token{store\_u32}&1&$\memwr_{\immed_X\dots+4} = \fixedencode{4}{\reg_A \bmod 2^{32}}$\\ \mrule
  62&\token{store\_u64}&1&$\memwr_{\immed_X\dots+8} = \fixedencode{8}{\reg_A}$\\
\bottomrule
\end{longtable}
...
\begin{longtable}{p{8mm} p{25mm} p{5mm} p{100mm}}
  ...
  71&\token{store\_imm\_ind\_u16}&1&$\memwr_{\reg_A + \immed_X \dots+ 2} = \fixedencode{2}{\immed_Y \bmod 2^{16}}$\\ \mrule
  72&\token{store\_imm\_ind\_u32}&1&$\memwr_{\reg_A + \immed_X \dots+ 4} = \fixedencode{4}{\immed_Y \bmod 2^{32}}$\\ \mrule
  73&\token{store\_imm\_ind\_u64}&1&$\memwr_{\reg_A + \immed_X \dots+ 8} = \fixedencode{8}{\immed_Y}$\\
  \bottomrule
\end{longtable}
...
\begin{longtable}{p{8mm} p{35mm} p{5mm} p{100mm}}
  ...
  121&\token{store\_ind\_u16}&1&$\memwr_{\reg_B + \immed_X \dots+ 2} = \fixedencode{2}{\reg_A \bmod 2^{16}}$\\ \mrule
  122&\token{store\_ind\_u32}&1&$\memwr_{\reg_B + \immed_X \dots+ 4} = \fixedencode{4}{\reg_A \bmod 2^{32}}$\\ \mrule
  123&\token{store\_ind\_u64}&1&$\memwr_{\reg_B + \immed_X \dots+ 8} = \fixedencode{8}{\reg_A}$\\ \mrule
  ...
  126&\token{load\_ind\_u16}&1&$\reg'_A = \decode{2}{\memr_{\reg_B + \immed_X\dots+2}}$\\ \mrule
  127&\token{load\_ind\_i16}&1&$\reg'_A = \unsigned{\signedn{2}{\decode{2}{\memr_{\reg_B + \immed_X\dots+2}}}}$\\ \mrule
  128&\token{load\_ind\_u32}&1&$\reg'_A = \decode{4}{\memr_{\reg_B + \immed_X\dots+4}}$\\ \mrule
  129&\token{load\_ind\_i32}&1&$\reg'_A = \unsigned{\signedn{4}{\decode{4}{\memr_{\reg_B + \immed_X\dots+4}}}}$\\ \mrule
  130&\token{load\_ind\_u64}&1&$\reg'_A = \decode{8}{\memr_{\reg_B + \immed_X\dots+8}}$\\ \mrule
