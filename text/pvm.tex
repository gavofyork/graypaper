...
\begin{align}
  \Psi&\colon \left\{\begin{aligned}
    (\blob, \N_R, \N_G, \regs, \ram) &\to (\{\halt, \panic, \oog\} \cup \{\fault, \host\} \times \N_R, \N_R, \Z_G, \regs, \ram)\\
...
\begin{equation}
  \Psi_1\colon \left\{\begin{aligned}
    (\blob, \mathbb{B}, \seq{\N_R}, \N_R, \N_G, \regs, \ram) &\to (\{\panic, \halt, \continue \} \cup \{\fault, \host\} \times \N_R, \N_R, \Z_G, \regs, \ram)\\
...
\begin{align}
  &\Psi_H\colon \left\{\begin{aligned}
    \tuple{\begin{aligned}
      &\blob, \N_R, \N_G, \regs,\\&\ram, \Omega\langle X \rangle, X
    \end{aligned}
    }
    &\to
...
\begin{equation}
  \Psi_M\colon \left\{\begin{aligned}
    \left(
      \blob, \N_R, \N_G, \blob_{:\mathsf{Z}_I}, \Omega\langle X \rangle, X
    \right) &\to (\N_G, \blob \cup \{\panic, \oog\}, X)\\
