...
\begin{longtable}{p{8mm} p{25mm} p{5mm} p{100mm}}
  ...
  \midrule
  \endhead
  6&\token{load\_imm\_jump}&0&$\token{branch}(\immed_X, \top)\ ,\qquad \reg_A' = R(\imath)$\\ \mrule
