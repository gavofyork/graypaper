...
\begin{align}
  ...
  \varepsilon^\mu &= \begin{cases}
    ...
    \fault \times 2^{12}\floor{\min(\mathbf{x}) \bmod 2^{32} \div 2^{12}} &\otherwise
  \end{cases}
\end{align}
