...
\begin{align}\label{eq:transitionfunctioncomposition}
  ...
  \reportspostassurances &\prec \tup{\xtassurances, \reportspostjudgement} \label{eq:rhoddagger} \\
  \reports' &\prec \tup{\xtguarantees, \reportspostassurances, \activeset, \thetime'} \label{eq:rhoprime} \\
