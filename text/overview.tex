...
Finally, details of the most recent blocks and timeslot are tracked in $\beta$ and $\tau$ respectively and, judgments are tracked in $\psi$ and validator statistics are tracked in $\pi$.
