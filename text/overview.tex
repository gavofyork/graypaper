...
We refer to the time-proportional computational steps as \emph{gas} (much like in the \emph{YP}) and limit it to a 64-bit quantity. Within the context of the \textsc{pvm}, $\gascounter \in \gas$ is typically used to denote gas.
