...
\begin{align}\label{eq:statecomposition}
  \thestate &\equiv (\authpool, \recenthistory, \safrole, \accounts, \entropy, \stagingset, \activeset, \previousset, \rho, \thetime, \varphi, \privileges, \psi, \pi, \ready, \accumulated)
\end{align}
...
\begin{align}\label{eq:transitionfunctioncomposition}
  ...
  \safrole' &\prec (\theheader, \thetime, \xttickets, \safrole, \stagingset, \entropy', \activeset', \psi') \\
