...
\begin{equation}
  \itemtoresult\colon\left\{\begin{aligned}
    ...
    \end{aligned}
      ...
      s, c, \is{\wl¬payloadhash}{\hash(\mathbf{y})}, \is{g}{a}, \wl¬result, u,\\
...
\begin{align*}
  ...
  \countupexports(\wpX, j) \equiv \,&\begin{cases}
    ...
    \multicolumn{2}{l}{\also h = \hash(\wpX)\,,\; w = \wpX_\wp¬workitems[j]\,,\; \ell = \sum_{k < j}\wpX_\wp¬workitems[k]_\wi¬exportsegments}
  \end{cases}
\end{align*}
