...
where:
\begin{align*}
  \keys{\mathbf{l}} &\equiv \{ h \mid w \in p_\mathbf{w}, (h^\boxplus, n) \in w_\mathbf{i} \} \wedge |\mathbf{l}| \le 8\\
  ...
  &\!\!\!\!\!\!\!\!\where h = \mathcal{H}(\wpX)\,,\; w = \wpX_\wp¬workitems[j]\,,\; \ell = \sum_{k < j}\wpX_\wp¬workitems[k]_\wi¬exportsegments
\end{align*}
