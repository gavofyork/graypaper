...
\begin{equation}
  \!\!\!\!\begin{aligned}
    ...
    &\ \sum_{\wiX \in \wpX_\wp¬workitems} \wiX_\wi¬exportcount \le \mathsf{W}_M \ \wedge\ 
...
\begin{align}
  ...
  &\begin{aligned}
    &\forall \wpX \in \mathbb{P}: \Big(|\wpX_\wp¬authtoken| + |\wp¬authconfig| +
...
Given the result $\wl¬result$ of some work-item, we define the item-to-digest function $\itemtodigest$ as:
\begin{equation}
