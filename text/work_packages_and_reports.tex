...
Where:
\begin{align*}
  \Fkeys{\wr¬srlookup} \equiv \,&\{ h \mid \wiX \in \wpX_\mathbf{w}, (h^\boxplus, n) \in \wiX_\mathbf{i} \} \ ,\quad\len{\wr¬srlookup} \le 8\\
  ...
  \countupexports(\wpX, j) \equiv \,&\begin{cases}
    (\oversize, u, [\mathbb{G}_0, \mathbb{G}_0, \dots]_{\dots w_e}) &\when \len{r} + z > \mathsf{W}_R\\
...
\begin{equation}\label{eq:zeropadding}
  \zeropad_{n \in \N_{1\dots}}\colon\left\{\begin{aligned}
