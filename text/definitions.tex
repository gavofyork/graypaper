...
\begin{description}
  ...
  \begin{description}
    ...
    \item[$\preimagelen$] The set of lengths under which a preimage may be solicited. A subset of $\bloblength$, equivalent to $\Nmax{2^{32} - 2}$. See equation \ref{eq:serviceaccount}.
...
%  \item[$\Sigma$] Unused.
  ...
  \begin{description}
    ...
    \item[$\Omega_V$] Set-supervisor host-call.
...
\begin{description}
  ...
  \item[$\fnmemgas(L, \ell)$] The memory-sized gas function. See equation \ref{eq:fnmemgas}.
...
\begin{description}
  ...
  \item[$\Cexpungeperiod = 19,200$] The period in timeslots after which an unreferenced preimage may be expunged. See \texttt{forget} definition in section \ref{sec:accumulatefunctions}.
  ...
  \item[$\mathsf{M}$] Host-function gas costs, see below.
  ...
  \item[$\Cmaxservicecodesize = 4,000,000$] The maximum size of service code in octets. See equations \ref{eq:refinvocation} \& \ref{eq:accinvocation}.
  ...
  \item[$\Cpvmgasdeliver = 500$] The gas cost, per 1024 octets, of the eventual read-back, from the node's state or context, of data that a host-call writes into a machine's \textsc{ram}. See appendix \ref{sec:hostfunctions}.
...
\begin{description}
  ...
  \item[$\CgasDconst = 1100$] $\Omega_D$ (\texttt{designate}) base gas cost.
  \item[$\CgasDlinear = 302$] $\Omega_D$ (\texttt{designate}) gas per validator.
  ...
  \item[$\CgasV = 1000$] $\Omega_V$ (\texttt{supervisor}) base gas cost.
  ...
  \item[$\CgasYc{0} = 390, \CgasYl{0} = 0$] $\Omega_Y$ (\texttt{fetch}) case 0: protocol parameters.
  \item[$\CgasYc{1} = 103, \CgasYl{1} = 0$] $\Omega_Y$ (\texttt{fetch}) case 1: entropy.
  \item[$\CgasYc{2} = 80, \CgasYl{2} = 96$] $\Omega_Y$ (\texttt{fetch}) case 2: auth trace.
  \item[$\CgasYc{3} = 85, \CgasYl{3} = 96$] $\Omega_Y$ (\texttt{fetch}) case 3: any extrinsic, by index.
  \item[$\CgasYc{4} = 85, \CgasYl{4} = 96$] $\Omega_Y$ (\texttt{fetch}) case 4: our extrinsic, by index.
  \item[$\CgasYc{5} = 171, \CgasYl{5} = 0$] $\Omega_Y$ (\texttt{fetch}) case 5: any import, by index.
  \item[$\CgasYc{6} = 171, \CgasYl{6} = 0$] $\Omega_Y$ (\texttt{fetch}) case 6: our import, by index.
  \item[$\CgasYc{7} = 85, \CgasYl{7} = 96$] $\Omega_Y$ (\texttt{fetch}) case 7: encoded work-package.
  \item[$\CgasYc{8} = 84, \CgasYl{8} = 0$] $\Omega_Y$ (\texttt{fetch}) case 8: auth config.
  \item[$\CgasYc{9} = 88, \CgasYl{9} = 0$] $\Omega_Y$ (\texttt{fetch}) case 9: auth token.
  \item[$\CgasYc{10} = 111, \CgasYl{10} = 0$] $\Omega_Y$ (\texttt{fetch}) case 10: refine context.
  \item[$\CgasYc{11} = 317, \CgasYl{11} = 0$] $\Omega_Y$ (\texttt{fetch}) case 11: items summary.
  \item[$\CgasYc{12} = 250, \CgasYl{12} = 0$] $\Omega_Y$ (\texttt{fetch}) case 12: any item summary.
  \item[$\CgasYc{13} = 95, \CgasYl{13} = 96$] $\Omega_Y$ (\texttt{fetch}) case 13: any payload.
  \item[$\CgasYc{14} = 287, \CgasYl{14} = 400$] $\Omega_Y$ (\texttt{fetch}) case 14: accumulate items.
  \item[$\CgasYc{15} = 355, \CgasYl{15} = 344$] $\Omega_Y$ (\texttt{fetch}) case 15: any accumulate item.
  \item[$\CgasYunknown = 80$] $\Omega_Y$ (\texttt{fetch}) otherwise: nothing.
  ...
  \item[$\CgasZinvalid = 80$] $\Omega_Z$ (\texttt{pages}) invalid-$r$ base gas cost.
