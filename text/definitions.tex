...
%  \item[$\mathcal{D}$] Unused.
  ...
  \item[$\sext_n(\dots)$] The signed-extension function for a value in $\Nbits{8n}$. See equation \ref{eq:signedextension}.
  ...
  \item[$\tosigned_n(\dots)$] The into-signed function for a value in $\Nbits{8n}$. Superscripted with ${}^{-1}$ to denote the inverse. See equation \ref{eq:signedfunc}.
\end{description}
