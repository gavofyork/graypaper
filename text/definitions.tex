...
\begin{description}
  ...
  \item[$\psi$] Votes regarding any ongoing disputes. %	ψ
...
\begin{description}
  ...
  \item[$\mathsf{W}_P = 6\cdot2^{20} + 2^{16}$] The maximum size of an encoded work-package in octets.
