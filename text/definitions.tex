...
\begin{description}
  ...
  \item[$\Cmaxticketfirstbyte = 31$] The maximum value of the first byte of a Safrole ticket permitted to enter the contest.
  \item[$\Cticketentries = 16$] The number of ticket entries per validator. See equation \ref{eq:ticketsextrinsic}.
