...
\begin{description}
  ...
  \item[$\CgasGammamem = 1862$] $\Omega_\Gamma$ (\texttt{compile}) base gas cost when compiling from memory.
  \item[$\CgasGammadb = 1862$] $\Omega_\Gamma$ (\texttt{compile}) base gas cost when compiling from the database.
