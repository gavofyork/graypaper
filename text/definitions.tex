...
\begin{description}
  ...
  \item[$\Cmaxextrinsicverdicts = 16$] The maximum number of verdicts which may be included in a single extrinsic. See equation \ref{eq:limitextrinsicverdicts}.
  \item[$\Cmaxextrinsicoffenses = 16$] The maximum number each of culprits or faults which may be included in a single extrinsic. See equations \ref{eq:limitextrinsicculprits} and \ref{eq:limitextrinsicfaults}.
