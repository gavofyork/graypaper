...
\begin{description}
  ...
  \item[$\mathsf{W}_S = 6$] The size of an exported segment in erasure-coded pieces in octets.
  ...
  \item[$\mathsf{Z}_J = 2^{16}$] The standard \textsc{pvm} program initialization major zone size. See section \ref{sec:standardprograminit}.
  \item[$\mathsf{Z}_N = 2^{14}$] The standard \textsc{pvm} program initialization minor zone size. See section \ref{sec:standardprograminit}.
