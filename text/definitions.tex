...
%  \item[$\Sigma$] Unused.
  ...
  \begin{description}
    ...
    \item[$\Omega_V$] Set-authority-service host-call.
...
\begin{description}
  ...
  \item[$\fneffectiveauthority(\dots)$] The effective authority function. See equation \ref{eq:effectiveauthority}.
...
\begin{description}
  ...
  \item[$\CgasV = 1000$] $\Omega_V$ (\texttt{authority}) base gas cost.
