...
\begin{description}
  ...
  \item[$\Cpvmgasdeliver = 500$] The gas cost, per 1024 octets, added to the memory rate of a host-call which writes data into a machine's \textsc{ram}, bypassing its working-set. See appendix \ref{sec:hostfunctions}.
