...
\begin{description}
  ...
  \item[$\Cexpungeperiod = 19,200$] The period in timeslots after which an unreferenced preimage may be expunged. See \texttt{forget} and \texttt{eject} definitions in section \ref{sec:accumulatefunctions}.
