...
\begin{description}
  ...
  \item[$\fnmemgas(L, \ell)$] The memory-sized gas function: $\fnmemgas(L, \ell) = \ffrac{L \cdot \ell + 1024}{1024}$. See equation \ref{eq:fnmemgas}.
...
\begin{description}
  \item[$\Cgaschunksize = 1024$] The octet denominator for memory-sized gas (used in $\fnmemgas$, see equation \ref{eq:fnmemgas}).
