...
\begin{equation}\label{eq:effectivesupervisor}
  \fneffectivesupervisor\colon\abracegroup{
    ...
    \tup{\mathbf{d}, s} &\mapsto \begin{cases}
      ...
      s &\otherwise
    \end{cases} \\
    &\phantom{{}\mapsto{}} \where \tup{u, r} = \mathbf{d}\subb{s}_\sa¬supervisor
  }
\end{equation}
