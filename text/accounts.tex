...
\begin{align}
  \forall \mathbf{a} \in \Fvalues{\accounts}:\left\{\begin{aligned}
    \mathbf{a}_\sa¬items \in \Nbits{32} &\equiv 2\cdot\len{\,\mathbf{a}_\sa¬requests\,} + \len{\,\mathbf{a}_\sa¬storage\,} \\
    \mathbf{a}_\sa¬octets \in \Nbits{64} &\equiv \sum\limits_{\,(h, z) \in \Fkeys{\mathbf{a}_\sa¬requests}\,} \!\!\!\!81 + z \\
