...
\begin{align}
  ...
  \begin{aligned}
    &r \in \badset' \,,\\
    &k \in (\lambda \cup \kappa) \setminus \offenders \,,\\
...
\begin{equation}
  \mathbf{H}_j \equiv \order{(\badset' \cup \wonkyset') \setminus (\badset \cup \wonkyset)}
\end{equation}
\begin{equation}
  \mathbf{H}_o \equiv \order{\offenders' \setminus \offenders}
\end{equation}
