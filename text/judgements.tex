...
\begin{align}
  ...
  \punishset' &\equiv \punishset \cup \{ k \mid (r, k, s) \in \xtculprits \}\cup \{ k \mid (r, v, k, s) \in \xtfaults \}
\end{align}

\subsection{Header}\label{sec:judgementmarker}

The judgement marker must contain exactly the sequence of report hashes of all bad and wonky verdicts:
\begin{equation}
