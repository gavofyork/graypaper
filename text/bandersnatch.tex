...
\begin{align}
  \bandersig{k \in \bskey}{c \in \hash}{m \in \blob} \subset \bloboflen{96} &\equiv \set{\build{x}{x \in \bloboflen{96}, \text{verify}(k, c, m, x) = \top }}  \\
  \banderout{s \in \bandersig{k}{c}{m}} \in \hash &\equiv \text{output}(x \mid x \in \bandersig{k}{c}{m})\interval{}{32}
\end{align}
...
\begin{align}
  ...
  \bandersnatch{r \in \ringroot}{c \in \hash}{m \in \blob} \subset \bloboflen{784} &\equiv \set{\build{x}{x \in \bloboflen{784}, \text{verify}(r, c, m, x) = \top }}  \\
  \banderout{p \in \bandersnatch{r}{c}{m}} \in \hash &\equiv \text{output}(x \mid x \in \bandersnatch{r}{c}{m})\interval{}{32}
\end{align}
