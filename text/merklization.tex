  ...
  \begin{aligned}
    ...
    \where P&\colon\deffunc{
      ...
      (\mathbf{r}, l, n, H) &\mapsto \begin{cases}
        \mathbf{r} \doubleplus l &\when n \ge \len{\mathbf{r}}\\
...
\begin{equation}
  \mathcal{M}_R\colon\deffunc{
    ...
    \mathbf{b} &\mapsto \begin{cases}
      ...
      \keccak(\token{\$peak} \concat \mathcal{M}_R(\mathbf{h}_{\dots\len{\mathbf{h}}-1}) \concat \mathbf{h}_{\len{\mathbf{h}}-1}) &\otherwise \\
