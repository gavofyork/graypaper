...
\begin{equation}
  T(\thestate) \equiv \abracegroup{
    ...
    &&C(5) &\mapsto \se(\var{\sqorderby{x}{x \in \goodset}}, \var{\sqorderby{x}{x \in \badset}}, \var{\sqorderby{x}{x \in \wonkyset}}, \var{\sqorderby{x}{x \in \offenders}}) \;, \\
...
\begin{equation}
  N\colon\abracegroup{
    (\seq{\bloboflen{n}}, \blob \to \hash) &\to \bloboflen{n} \cup \hash \\
...
\begin{equation}
  T\colon\abracegroup{
    (\seq{\bloboflen{n}}, \Nmax{\len{\mathbf{v}}}, \blob \to \hash)\ &\to \seq{\bloboflen{n} \cup \hash}\\
...
\begin{align}
  ...
  \merklejustsubpath_x&\colon \abracegroup{
    (\seq{\blob}, \Nmax{\len{\mathbf{v}}}, \blob \to \hash) &\to \seq{\hash}\\
