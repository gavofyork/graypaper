...
\begin{equation}
  T(\thestate) \equiv \abracegroup{
    ...
    &&C(3) &\mapsto \se(\var{[\tup{h, b, s, \var{\mathbf{p}}}\mid \tup{h, b, s, \mathbf{p}} \orderedin \recenthistory]}, \Fmmrencode{\beefybelt}) \;, \\
    ...
    &&C(10) &\mapsto \se(\sq{\build{\maybe{\tup{w, \fixedencode{4}{t}}}}{\tup{w, t} \orderedin \reports}}) \;, \\
    ...
    &&C(14) &\mapsto \se(\sq{\build{\var{\tup{\mathbf{w}, \var{\mathbf{d}}}}}{\tup{\mathbf{w}, \mathbf{d}} \orderedin \mathbf{i} \mid \mathbf{i} \orderedin \ready}}) \;, \\
    &&C(15) &\mapsto \encode{\sq{\build{\var{\mathbf{i}}}{\mathbf{i} \orderedin \accumulated}}} \;, \\
    &&C(16) &\mapsto \se(\var{\sq{\build{\tup{\fixedencode{4}{s}, \encode{h}}}{\tup{s, h} \orderedin \lastaccout}}}) \;, \\
    ...
    \forall (s \mapsto \mathbf{a}) \in \accounts, \kv{\tup{h, l}}{\mathbf{t}} \in \mathbf{a}_\mathbf{l}: &&C(s, \fixedencode{4}{l} \concat h) &\mapsto \encode{\var{\sq{\build{\fixedencode{4}{x}}{x \orderedin \mathbf{t}}}}}
  }
\end{equation}
...
\begin{equation}
  \begin{aligned}
    ...
    \also R&\colon\deffunc{
      ...
      \tup{\mathbf{s}, i, v} &\mapsto \mathbf{s}'\ \where \mathbf{s}' = \mathbf{s} \exc \mathbf{s}'_i = v
    }
  \end{aligned}
\end{equation}
