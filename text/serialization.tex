...
\begin{align}
  ...
  \se(x \in \mathbb{L}) &\equiv \se(\se_4(x_s), x_c, x_y, \se_8(x_g), O(x_\wl¬data), x_u, x_i, x_x, x_z, x_e)\\
  \se(x \in \mathbb{W}) &\equiv \se(x_s, x_x, x_c, x_a, \var{x_\wr¬authoutput}, \var{x_\mathbf{l}}, \var{x_\wr¬results}, x_g) \\
  ...
  \se(x \in \operandtuple) &\equiv \se(x_\ot¬packagehash, x_\ot¬segroot, x_\ot¬authorizer, \var{x_\ot¬authoutput}, x_\ot¬payloadhash, x_\ot¬gaslimit, O(x_\ot¬data)) \\
