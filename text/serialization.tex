...
We define the serialization of $\bot$ and $\top$ as a single 0 and 1 octet respectively:
\begin{equation}
  \encode{\bot} \equiv \sq{0},\qquad\encode{\top} \equiv \sq{1}
\end{equation}
...
\begin{align}
  ...
  \encode{\wpX \in \workpackage} &\equiv \encode{
    ...
    \encode[2]{\wpX_\wp¬authworkingsetsize},
    \wpX_\wp¬context,
  ...
  \encode{\wiX \in \workitem} &\equiv \encode{
    ...
    \encode[2]{\wiX_\wi¬refworkingsetsize},
