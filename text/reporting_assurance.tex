...
\workreport \equiv \tuple{
  \begin{aligned}
    ...
    \isa{\wr¬digests}{\sequence{\mathbb{L}}_{1:\mathsf{I}}},\ 
...
\begin{equation}
  \guarantorassignments \in \tuple{\sequence{\coreindex}_\valcount, \sequence{\edkey}_\valcount}
\end{equation}
...
\begin{align}\label{eq:guaranteesextrinsic}
  \xtguarantees &\in \sequence{\tuple{
    \isa{\xg¬workreport}{\workreport},\,
    \isa{\xg¬timeslot}{\timeslot},\,
    \isa{\xg¬credential}{\sequence{\tuple{\valindex, \signature}}_{2:3}}
  }}_{:\corecount} \\
