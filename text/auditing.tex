...
\begin{align}\label{eq:auditselection}
  \local¬reports &\in \sequence{\optional{\workreport}}_\corecount \\
...
\begin{align}
  ...
  \where \mathbf{x}\sub{n} &= \se(\set{\build{\fixedencode{2}{\cX} \concat \blake(\wrX)}{\wrcX \in \local¬tranche\sub{n}}})\\
