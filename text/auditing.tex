...
\begin{align}\label{eq:auditselection}
  \local¬reports &\in \sequence[\corecount]{\optional{\workreport}} \\
...
\begin{align}
  \local¬seed\sub{0} &\in \bssignature{\activeset\subb{v}_\vk¬bs}{\mathsf{X}_U \concat \banderout{\H_\¬vrfsig}}{\sq{}} \\
...
\begin{align}
  S &\equiv \edsignature{\activeset\subb{v}_\vk¬ed}{\mathsf{X}_I \append n \concat \mathbf{x}\sub{n} \concat \blake{\H}} \\
...
\begin{align}
  \nonumber\forall n > 0:&\\
  \ \local¬seed\sub{n}(\wrX) &\in \bssignature{\activeset\subb{v}_\vk¬bs}{\mathsf{X}_U \concat \banderout{\H_\¬vrfsig}\concat\blake{\wrX}\append n}{\sq{}} \\
...
\begin{align}
  \mathbf{j}\sub{n} &= \set{\build{\edsigndata{\activeset\subb{v}_\vk¬ed}{\mathsf{X}_{e\sub{n}(\cX)} \concat \blake{\wrX}}}{\tup{\cX, \wrX} \in \local¬tranche\sub{n}}}
\end{align}
