...
\begin{align}
  s_0 &\in \bandersig{\kappa[v]_b}{\mathsf{X}_U \concat \banderout{\H_\¬vrfsig}}{[]} \\
...
\begin{equation}
  \using n = \ffrac{\mathcal{T} - \mathsf{P}\cdot\H_\¬timeslot}{\mathsf{A}}
\end{equation}
...
\begin{align}
  S &\equiv \sig{\kappa[v]_e}{\mathsf{X}_I \doubleplus n \concat \mathbf{x}_n \concat \blake(\H)} \\
...
\begin{align}
  \nonumber\forall n > 0:&\\
  \ s_n(w) &\in \bandersig{\kappa[v]_b}{\mathsf{X}_U \concat \banderout{\H_\¬vrfsig}\concat\blake(w)\doubleplus n}{[]} \\
