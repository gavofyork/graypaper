...
\begin{align}\label{eq:auditselection}
  \mathbf{Q} &\in \seq{\optional{\workreport}}_\corecount \\
  \mathbf{Q} &\equiv \sq{\build{
    \begin{rcases}
      \reports[c]_w &\when \reports[c]_w \in \mathbf{W} \\
      \none &\otherwise
    \end{rcases}
  }{
...
\begin{align}
  ...
  \where \mathbf{p} &= \Ffyshuffle{\sq{\build{\tup{c, \mathbf{Q}_c}}{c \orderedin \coreindex}}, r} \\
...
\begin{align}
  A_n: \workreport &\to \powset{\valindex} \\
...
\begin{align}
  J_{\{\bot, \top\}}: \workreport \to \powset{\valindex}
\end{align}
...
\begin{align}
  ...
  \ \mathbf{a}_n &\equiv \{ \textstyle\frac{\valcount}{256\mathsf{F}}\banderout{s_n(w)}_0 < m_n \mid w \in \mathbf{Q}, w \ne \none \}\!\!\!\!\\
