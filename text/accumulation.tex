...
\begin{align}\label{eq:servicestoaccumulate}
  \mathbf{S} \equiv \{ r_s \mid w \in \mathbf{R}, r \in w_r \} \cup \{ \chi_m, \chi_a, \chi_v \}
\end{align}
...
\begin{equation}
  G\colon\left\{\;\begin{aligned}
    \N_S &\to \Z_G \\
    \displaystyle s &\mapsto \!\!\sum_{w \in \mathbf{R}}\sum_{r \in w_r , r_s = s}{\!\!\!\!\!\!\!\delta^\dagger[s]_g + \left \lfloor r_g\cdot\frac{\displaystyle \mathsf{G}_A - \sum_{r \in w_r}{\delta^\dagger[r_s]_g}}{\sum_{r \in w_r}{r_g}} \right \rfloor }
  \end{aligned}\right.\!\!\!\!\!\!
\end{equation}
