...
\begin{align}
  &\mathbb{O} \equiv \tuple{\isa{\mathbf{o}}{\Y \cup \mathbb{J}}, \isa{a}{\H}, \isa{e}{\H}, \isa{l}{\H}, \isa{k}{\H}, \isa{\mathbf{a}}{\Y}}
\end{align}
\begin{align}
    ...
    &\ \begin{aligned}
      ...
      \mathbf{p} &= \left[ \tup{\begin{alignedat}{5}
        % TODO: Rename \mathbf{o} to something else, to allow mathbf{a} to become o.
        % TODO: Rename k to h. Then 5 of the 6 fields keep their names.
        \is{\mathbf{o}&}{\mathbf{r}_\mathbf{o}},
        \is{&e&}{(w_s)_e},
        \is{&\mathbf{a}&}{w_\mathbf{o}},\\
        \is{l&}{\mathbf{r}_l},
        \is{&k&}{(w_s)_h},
        \is{&a&}{w_a}
      \end{alignedat}}
