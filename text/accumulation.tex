...
\begin{align}
  ...
  \mathbf{I} &\equiv \{ s \mapsto (u, i) \mid \exists (s, x) \in \mathbf{u} \} \\
  \where i &= |\sq{r \mid w \orderedin \mathbf{W}^* , r \orderedin w_\mathbf{r} , r_s = s }| \\
  \also u &= \sum_{(s, x) \in \mathbf{u}}x
\end{align}
