...
\begin{equation}
  \local¬fnpartitionxfers\colon\abracegroup{
    ...
    \end{cases} \\
    &\quad\where d = t_\dx¬dest \in \mathbf{d} \land \fneffectivesupervisor(\mathbf{d}, t_\dx¬dest) \in \mathbf{s} \setminus \set{t_\dx¬dest} \\
  ...
  \accpar\colon\abracegroup[\;]{\begin{aligned}
    ...
    &\ \begin{aligned}
      ...
      \local¬acc(s) &\equiv \begin{cases}
        N(\mathbf{o}) &\when s \in \mathbf{o}_\ao¬modifiedaccounts \land s \in \mathbf{y}_\ao¬modifiedaccounts \setminus \set{\fneffectivesupervisor(\ps¬accounts, s)} \\
        \mathbf{o} &\otherwise
      \end{cases} \\
      &\phantom{{}\equiv{}} \where \mathbf{o} = \accone(\psX, \mathbf{t}, \mathbf{r}, \mathbf{f}, s) \\
      &\phantom{{}\equiv{}} \also \mathbf{y} = \accone(\psX, \mathbf{t}, \mathbf{r}, \mathbf{f}, \fneffectivesupervisor(\ps¬accounts, s)) \\
      \mathbf{u} &= \sq{\build{
      ...
      M(s) &\equiv \begin{cases}
        ...
        (\local¬acc(\fneffectivesupervisor(\ps¬accounts, s))_\ao¬poststate)_\ps¬accounts\subb{s} &\otherwise
      \end{cases} \\
