...
\begin{align}
  \ready &\in \seq{\seq{(\workreport, \{\H\})}}_\mathsf{E}
\end{align}
...
\begin{equation}
  E\colon\left\{\begin{aligned}
      &(\seq{(\workreport, \{\H\})}, \{\H\}) \to \seq{(\workreport, \{\H\})} \\
...
\begin{equation}
  Q\colon\left\{\begin{aligned}
    &\seq{(\workreport, \{\H\})} \to \seq{\workreport} \\
...
\begin{align}
  \using m &= \h¬timeslot \bmod \mathsf{E}\\
...
\begin{equation}
  \Delta_+\colon\left\{\begin{aligned}
    &(\N_G, \seq{\workreport}, \partialstate, \dict{\N_S}{\N_G}) \to (\N, \partialstate, \defxfers, \servouts, \gasused) \\
...
\begin{equation}
  \Delta_*\colon\left\{\;\begin{aligned}
    &(\partialstate, \seq{\workreport}, \dict{\N_S}{\N_G}) \to (\partialstate, \defxfers, \servouts, \gasused) \\
