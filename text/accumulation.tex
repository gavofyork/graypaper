...
\newcommand*{\¬accounts}{\ps¬accounts}
\newcommand*{\¬stagingset}{\ps¬stagingset}
\newcommand*{\¬authqueue}{\ps¬authqueue}
\newcommand*{\¬manager}{\ps¬manager}
\newcommand*{\¬assigners}{\ps¬assigners}
\newcommand*{\¬delegator}{\ps¬delegator}
\newcommand*{\¬alwaysaccers}{\ps¬alwaysaccers}
...
\begin{equation}
  \accpar\colon\abracegroup[\;]{\begin{aligned}
    ...
    &\tup{\mathbf{o}, \mathbf{w}, \mathbf{f}} \mapsto \tup{
      \tup{
        \¬accounts', \¬stagingset', \¬authqueue', \¬manager', \¬assigners', \¬delegator', \¬alwaysaccers'
    ...
    &\ \begin{aligned}
      ...
      \mathbf{b} &= \set{\build{
          ...
          s \in \mathbf{s},\,
          b = \accone(\mathbf{o}, \mathbf{w}, \mathbf{f}, s)_\ao¬accout,\,
          b \ne \none
        }} \\
      \mathbf{t} &= \sq{\build{
      ...
      \tup{\¬manager', \¬assigners^*, \¬delegator^*, \¬alwaysaccers'} &=
      ...
      \forall c \in \coreindex :
        \¬assigners'\sub{c} &= ((
          \accone(\mathbf{o}, \mathbf{w}, \mathbf{f}, \¬assigners^*\sub{c})_\ao¬poststate
        )_\ps¬assigners)\sub{c} \\
      \¬delegator' &= (
          \accone(\mathbf{o}, \mathbf{w}, \mathbf{f}, \¬delegator^*)_\ao¬poststate
        )_\ps¬delegator \\
      \¬stagingset' &= (
