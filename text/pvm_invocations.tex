...
\begin{longtable}{p{3.5cm} p{12.5cm}}
  ...
  \cmidrule(lr){1-1}\cmidrule(lr){2-2}
  \makecell*[l]{
  $\Omega_Y(\gascounter, \registers, \memory, p, n, \mathbf{r}, i, \overline{\mathbf{i}}, \overline{\mathbf{x}}, \mathbf{o}, \mathbf{t})$ \\
  \texttt{fetch} = 1 \\
  $g = 10$} &
  $\begin{aligned}
  ...
  $\begin{aligned}
    ...
    \using \mathbf{m} &= \begin{cases}
      \mathcal{E}(\mathbf{t}_c, \mathbf{t}_b, \mathbf{t}_t, \mathbf{t}_g, \mathbf{t}_m, \mathbf{t}_o, \mathbf{t}_i, \mathbf{t}_f, \mathbf{t}_r, \mathbf{t}_a, \mathbf{t}_p) &\when \mathbf{t} \ne \none \\
      \none &\otherwise
    \end{cases} \\
