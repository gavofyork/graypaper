...
\begin{longtable}{p{3.5cm} p{12.5cm}}
  ...
  $\begin{aligned}
    ...
    \using \mathbf{s} &= \begin{cases}
      \none &\when n \not\in \keys{\mathbf{m}}\\
      \mathbf{m}[n]_{\mathbf{u}_{s\dots+l}} &\when \N_{s\dots+l} \in \mathbb{V}_{\mathbf{m}[n]_\mathbf{u}} \wedge \N_{o\dots+l} \in \mathbb{V}^*_\memory \\
      \error &\otherwise
    \end{cases}\\
  ...
  $\begin{aligned}
    ...
    \using \mathbf{s} &= \begin{cases}
      \none &\when n \not\in \keys{\mathbf{m}} \\
      \mem_{s\dots+l} &\when \N_{s\dots+l} \in \mathbb{V}_\memory \wedge \N_{o\dots+l} \in \mathbb{V}^*_{\mathbf{m}[n]_\mathbf{u}} \\
      \error &\otherwise
    \end{cases}\\
    (\registers'_7, \mathbf{m}') &\equiv \begin{cases}
