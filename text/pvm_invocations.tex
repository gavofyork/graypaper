...
\begin{align}
  \Psi_A& \colon\left\{\begin{aligned}
    ...
    (\mathbf{u}, t, s, g, \mathbf{o}) &\mapsto \begin{cases}
      ...
      C(\Psi_M(\mathbf{c}, 5, g, \se(\se_4(t), \se_4(s), \var{\mathbf{o}}), F, I(\mathbf{u}, s)^2)) &\otherwise \\
...
\begin{align}
  \Psi_T &: \begin{cases}
    ...
    \multicolumn{2}{l}{
      \begin{aligned}
        \quad\where (u, \mathbf{r}, \mathbf{s}') &= \Psi_M(\mathbf{s}_\mathbf{c}, 10, \sum_{r \in \mathbf{t}}{(r_g)}, \se(\se_4(t), \se_4(s), \var{\mathbf{t}}), F, \mathbf{s}) \\
