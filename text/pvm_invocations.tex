...
\begin{align}
  \Psi_A& \colon\left\{\begin{aligned}
    ...
    (\mathbf{u}, s, g, \mathbf{o}) &\mapsto \begin{cases}
      ...
      C(\Psi_M(\mathbf{u}_\mathbf{d}[s]_\mathbf{c}, 5, g, \mathcal{E}(\var{\mathbf{o}}), F, \tup{I(\mathbf{u}, s), I(\mathbf{u}, s)})) &\otherwise
    \end{cases} \\
  \end{aligned}\right.\\
...
\begin{align}
  \Psi_T &: \begin{cases}
    ...
    \Psi_M(\mathbf{s}_\mathbf{c}, 10, \sum_{r \in \mathbf{t}}{(r_g)}, \mathcal{E}(\mathbf{t}), F, \mathbf{s}) &\otherwise
    \end{cases} \\
  \end{cases} \\
