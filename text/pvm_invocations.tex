...
\begin{longtable}{p{5cm} p{11cm}}
  ...
  \texttt{grow\_heap} = 1 \\
  $g = \CgasGeminiconst + \max(0, \registers_7 - h) \cdot \CgasGeminilinear$} &
  $\begin{aligned}
  ...
  \texttt{lookup} = 3 \\
  $g = \CgasLconst + \fnmemgas(\CgasLlinear, \len{\mathbf{v}}) $} &
  $\begin{aligned}
  ...
  \texttt{read} = 4 \\
  $g = \CgasRconst + \fnmemgas(\CgasRkeylinear, k_Z) + \fnmemgas(\CgasRvallinear, \len{\mathbf{v}}) $} &
  $\begin{aligned}
    \using s^* &= \begin{cases}
...
\begin{longtable}{p{4cm} p{12cm}}
  ...
  $g = \CgasHconst + \fnmemgas(\CgasHlinear, \len{\mathbf{v}})$} &
  $\begin{aligned}
    \using \mathbf{a} &= \begin{cases}
  ...
  \texttt{machine} = 9 \\
  $g = \CgasMconst + \fnmemgas(\CgasMlinear, \len{\mathbf{p}})$ }&
  $\begin{aligned}
  ...
  \texttt{pages} = 12 \\
  $g =  \begin{cases} \CgasZfreeconst + c \cdot \CgasZfreelinear &\when r = 0 \\ \CgasZallocconst + c \cdot \CgasZalloclinear &\when r \in \set{1, 2} \\ \CgasZsetmodeconst + c \cdot \CgasZsetmodelinear &\when r \in \set{3, 4} \end{cases} $ }&
  $\begin{aligned}
