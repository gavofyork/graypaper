...
\begin{align}
  ...
  \left\{ \begin{aligned}
    ...
    i &= \text{check}((\de_4(\mathcal{H}(\se(s, \eta'_0, \mathbf{H}_t))) \bmod (2^{32}-2^9)) + 2^8)
  \end{aligned} \right. \\
...
\begin{longtable}{p{3.5cm} p{12.5cm}}
  ...
  $\begin{aligned}
    ...
    (\omega'_0, \mathbf{x}'_\mathbf{s}, \mathbf{x}'_\mathbf{t}) &\equiv \begin{cases}
      ...
      (\mathtt{OOB}, \mathbf{x}_\mathbf{s}, \mathbf{x}_\mathbf{t}) &\otherwhen t = \error \\
      (\mathtt{WHO}, \mathbf{x}_\mathbf{s}, \mathbf{x}_\mathbf{t}) &\otherwhen d \not \in \keys{\delta \cup \mathbf{x}_\mathbf{n}} \\
      (\mathtt{LOW}, \mathbf{x}_\mathbf{s}, \mathbf{x}_\mathbf{t}) &\otherwhen g < (\delta \cup \mathbf{x}_\mathbf{n})[d]_m \\
