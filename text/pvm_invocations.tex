...
\begin{longtable}{p{3.5cm} p{12.5cm}}
  ...
  $\begin{aligned}
    ...
    %
    % It returns the number of accessible pages in the RW data region, regardless of whether
    ...
    \using c &= |\Nclamp{a}{b} \subseteq \writable{\memory}| \\
    ...
    \tup{\execst', \gascounter', \registers'_7, (\mathbf{u}'_\ram¬access)\interval{a}{\registers_7}} &\equiv \begin{cases}
      % Not enough gas to even cover the constant cost of the call, regardless of whether it's a no-op or not.
      \tup{\oog, \gascounter, \registers_7, (\mathbf{u}_\ram¬access)\interval{a}{\registers_7}} &\when \gascounter < 100 \\
      ...
      \tup{\continue, \gascounter - 100, a + c, (\mathbf{u}_\ram¬access)\interval{a}{\registers_7}} &\otherwise \\
    \end{cases}
  \end{aligned}$\\
  \cmidrule(lr){1-1}\cmidrule(lr){2-2}
  \makecell*[l]{
