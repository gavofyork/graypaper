...
The inner \textsc{pvm} invocation host-calls, meanwhile, depend on an integrated \textsc{pvm} type, which we shall denote $\innerpvm$. It holds some program code, instruction counter and \textsc{ram}:
\begin{equation}\label{eq:innerpvm}
  \innerpvm \equiv \tuple{\isa{\pg¬code}{\blob}, \isa{\pg¬ram}{\ram}, \isa{\pg¬pc}{\pvmreg}}
\end{equation}
