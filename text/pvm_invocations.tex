...
\begin{longtable}{p{5cm} p{11cm}}
  ...
  $\begin{aligned}
    ...
    \tup{\execst, \gascounter', \registers'_7} &\equiv \begin{cases}
      ...
      \tup{\continue, \max(\gascounter - \CgasGeminiconst, 0), h} &\when \registers_7 \leq h \lor \registers_7 > b \\
...
\begin{longtable}{p{5cm} p{11cm}}
  ...
  $\begin{aligned}
    ...
    \gascounter' &\equiv \begin{cases}
      \max(\gascounter - \CgasK, 0) &\when \mathbf{w} = \error \vee n \not\in \keys{\mathbf{m}} \\
      \max(\gascounter - g + g_R', 0) &\otherwise
    \end{cases}\\
