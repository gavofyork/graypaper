...
\begin{longtable}{p{3.5cm} p{12.5cm}}
  ...
  \cmidrule(lr){1-1}\cmidrule(lr){2-2}
  \makecell*[l]{
  $\Omega_Y(\gascounter, \registers, \memory, p, n, \mathbf{r}, i, \overline{\mathbf{i}}, \overline{\mathbf{x}}, \mathbf{i}, \mathbf{H}, \dots)$ \\
  \texttt{fetch} = 1 \\
  $g = 10$} &
  $\begin{aligned}
