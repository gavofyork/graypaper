...
\begin{longtable}{p{3cm} p{13cm}}
  ...
  $\begin{aligned}
    ...
    \end{cases} \\
    \using p_d &= o \ne 0 \lor (\imX_\im¬id \in \set{\dx¬dest, \effectivesupervisor{\mathbf{d}}{\dx¬dest}} \land (x \in \set{1, 2} \lor s \ne d)) \\
