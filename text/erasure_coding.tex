...
\begin{equation}\label{eq:erasurecodinginv}
  \ecrecover_{k \in \N}\colon\abracegroup{
    ...
    \end{cases}
%      [ \ecrecover(\mathbf{y}, i) \mid \mathbf{y} \orderedin \transpose\sq{\build{\spl{2}(\mathbf{x})}{\tup{\mathbf{x}, i} \orderedin \mathbf{c}}} ]
  }
\end{equation}
