...
\title[JAM: Join-Accumulate Machine \\ {\smaller \textbf{Draft 0.3.0+changes \today}}]{Join-Accumulate Machine: A Semi-Coherent Scalable Trustless VM \\ {\smaller Draft 0.2.3+changes \today}}
\author{
  Dr. Gavin Wood\\
