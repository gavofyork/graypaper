...
\newcommand*{\¬gaslimit}{g} % also used for ¬refgaslimit
\newcommand*{\¬service}{s} % also used for ¬avspec
\newcommand*{\¬payloadhash}{y}
\newcommand*{\¬payload}{\mathbf{y}}
\newcommand*{\¬result}{\mathbf{d}}
\newcommand*{\¬authtrace}{\mathbf{o}}
\newcommand*{\¬core}{c} % also used for ¬codehash
\newcommand*{\¬authorizer}{a} % also used for ¬accgaslimit
...
\newcommand*{\wi¬codehash}{c}
\newcommand*{\wi¬payload}{\¬payload}
\newcommand*{\wi¬refgaslimit}{g}
\newcommand*{\wi¬accgaslimit}{a}
\newcommand*{\wi¬exportsegments}{e}
\newcommand*{\wi¬importsegments}{\mathbf{i}}
\newcommand*{\wi¬extrinsics}{\mathbf{x}}

\newcommand*{\wr¬avspec}{s}
\newcommand*{\wr¬context}{x} % TODO: Consider renaming to \mathbf{c} and/or making bold, like package
...
\newcommand*{\wr¬digests}{\mathbf{r}} % TODO: Consider renaming to avoid overloading \mathbf{r} reports vs results; maybe \mathbf{t} for results
...
\newcommand*{\wl¬codehash}{c}
\newcommand*{\wl¬payloadhash}{\¬payloadhash}
\newcommand*{\wl¬gaslimit}{\¬gaslimit}
\newcommand*{\wl¬result}{\¬result}
\newcommand*{\wl¬gasused}{u}
\newcommand*{\wl¬imports}{i}
\newcommand*{\wl¬xtcount}{x}
\newcommand*{\wl¬xtsize}{z}
\newcommand*{\wl¬exports}{e}

\newcommand*{\ot¬packagehash}{h}
\newcommand*{\ot¬segroot}{e}
