...
\title[JAM: Join-Accumulate Machine \\ {\smaller \textbf{Draft 0.3.2+changes \today}}]{Join-Accumulate Machine: A Semi-Coherent Scalable Trustless VM \\ {\smaller Draft 0.3.2+changes \today}}
\author{
  Dr. Gavin Wood\\
