...
\newcommand*{\jamdraftversionsuffix}{\input{VERSION_SUFFIX}\!\!\!}

\title[JAM: Join-Accumulate Machine \\ {\smaller \textbf{Draft \jamdraftversion\jamdraftversionsuffix\ \today}}]{Join-Accumulate Machine: A Semi-Coherent Scalable Trustless VM \\ {\smaller Draft \jamdraftversion\jamdraftversionsuffix\ \today}}
\author{
  Dr. Gavin Wood\\
