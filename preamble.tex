...
\newcommand*{\CgasYunknown}{\mathsf{M}_{Y,\none}}
...
\newcommand*{\im¬modifiedaccounts}{\mathbf{w}}
...
\newcommand*{\sa¬supervisor}{u}
\newcommand*{\sa¬supervisorcreated}{d}
\newcommand*{\sa¬supervisorbalance}{x}
...
% Takes two arguments, a service accounts dictionary and a service identifier, and returns the
% service's effective supervisor. This looks like a derived field but is a bit magic, see the
% definition in accounts.tex.
\newcommand*{\effectivesupervisor}[2]{#1\subb{#2}_e}
...
\newcommand*{\ao¬modifiedaccounts}{\mathbf{w}}
...
\newcommand*{\wscharge¬extwritegas}{\Theta^{\downarrow}_g}
