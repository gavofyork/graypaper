...
\newcommand*{\encode}[2][]{\fnfixedencode{#1}\left(#2\right)}
\newcommand*{\fixedencode}[2]{\fnfixedencode{#1}\left(#2\right)}
\newcommand*{\decode}[2][]{\fnfixeddecode{#1}\left(#2\right)}
...
\newcommand*{\blake}[2][]{\fnblake_{#1}\left(#2\right)}
\newcommand*{\blakemany}[2][]{\fnblake^\#_{#1}\left(#2\right)}
