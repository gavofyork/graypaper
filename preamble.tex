...
\newcommand*{\sefixed}[1]{\se_{#1}}
\newcommand*{\de}{\mathcal{E}^{-1}}
\newcommand*{\defixed}[1]{\de_{#1}}
...
\newcommand*{\encode}[1]{\se\left(#1\right)}
\newcommand*{\fixedencode}[2]{\sefixed{#1}\left(#2\right)}
\newcommand*{\decode}[1]{\de\left(#1\right)}
\newcommand*{\fixeddecode}[2]{\defixed{#1}\left(#2\right)}
