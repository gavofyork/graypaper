...
\newcommand*{\sequence}[1]{\left\lsem#1\right\rsem}
\newcommand*{\sequenceoflen}[2]{\sequence{#1}_{#2}} % sequence of fixed length
...
\newcommand*{\fnencode}{\mathcal{E}}
\newcommand*{\fnfixedencode}[1]{\fnencode_{#1}}
\newcommand*{\fndecode}{\mathcal{E}^{-1}}
\newcommand*{\fnfixeddecode}[1]{\fndecode_{#1}}
\newcommand*{\fnmmrencode}{\fnencode_M}
\newcommand*{\fnfyshuffle}{\mathcal{F}}
\newcommand*{\fnblake}{\mathcal{H}}
\newcommand*{\fnblakeprefix}[1]{\mathcal{H}_{#1}}
...
\newcommand*{\encode}[1]{\fnencode\left(#1\right)}
\newcommand*{\fixedencode}[2]{\fnfixedencode{#1}\left(#2\right)}
\newcommand*{\decode}[1]{\fndecode\left(#1\right)}
\newcommand*{\fixeddecode}[2]{\fnfixeddecode{#1}\left(#2\right)}
...
\newcommand*{\blakeprefix}[2]{\fnblakeprefix{#1}\left(#2\right)}
...
\newcommand*{\erasurecodeplex}[2][]{\fnerasurecode^\#_{#1}\left(#2\right)}
...
\newcommand*{\bitstringoflen}[1]{\mathbb{B}_{#1}}
...
\newcommand*{\bloboflen}[1]{\mathbb{Y}_{#1}}
...
\newcommand*{\blskey}{\bloboflen{L}}
\newcommand*{\metadatakey}{\bloboflen{128}}
\newcommand*{\ringroot}{\bloboflen{R}}
...
\newcommand*{\allvalkeys}{\sequence{\valkey}_{\valcount}}
...
\newcommand*{\encodetickets}[1]{\fnencode_T\left(#1\right)}
\newcommand*{\encodepreimages}[1]{\fnencode_P\left(#1\right)}
\newcommand*{\encodeguarantees}[1]{\fnencode_G\left(#1\right)}
\newcommand*{\encodeassurances}[1]{\fnencode_A\left(#1\right)}
\newcommand*{\encodedisputes}[1]{\fnencode_D\left(#1\right)}
...
\newcommand*{\fnencodeunsignedheader}{\mathcal{E}_U}
\newcommand*{\encodeunsignedheader}[1]{\fnencodeunsignedheader\left(#1\right)}
