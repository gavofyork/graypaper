...
% TODO: these are pure function names so should not be used directly in invocation and prefixed with fn
...
% TODO: get rid of F prefix - this should be standard.
...
\newcommand*{\merklizestate}[1]{\fnmerklizestate\left(#1\right)} % TODO: Make it take a parameter.
