...
\title[JAM: Join-Accumulate Machine \\ {\smaller \textbf{Draft 0.2.0 - \today}}]{Join-Accumulate Machine: A Semi-Coherent Scalable Trustless VM \\ {\smaller Draft 0.2.0 - \today}}
\author{
  Dr. Gavin Wood\\
