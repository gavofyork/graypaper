...
\newcommand*{\powset}[2][{}]{\wp\ang{#2}_{#1}} % TODO: Make it take a parameter.
...
% Primitive types
\newcommand*{\dict}[2]{\mathbb{D}\ang{#1\to#2}}
\newcommand*{\sig}[2]{\mathbb{E}_{#1}\ang{#2}}
\newcommand*{\bandersnatch}[3]{\bar{\mathbb{F}}_{#1}^{#3}\ang{#2}}
\newcommand*{\bandersig}[3]{\mathbb{F}_{#1}^{#3}\ang{#2}}
